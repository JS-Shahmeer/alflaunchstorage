  ...
  return (
    ...
    >
      ...
      <div className="relative z-10 max-w-4xl mx-auto px-6 flex flex-col items-center">
        <span ref={badgeRef} className="bg-[#b6ff7a] text-[#417a5a] font-semibold text-sm px-5 py-2 rounded-full mb-6 mt-2 shadow">
          All 50 States Covered
        </span>
        <h1 ref={headingRef} className="text-3xl md:text-4xl font-bold mb-3">Find Packages for Your State</h1>
        <p ref={subheadingRef} className="md:text-lg text-base text-white/90 max-w-2xl mx-auto">
          Every package is customized to meet your state's specific regulatory requirements.
        </p>
      </div>
    </section>
  );
